...
RADAR_CFG_LIST = [
    {'name'          : 'IWR1843_Ori',
     ...
     'ylim'          : (0.25, 4),
     'zlim'          : None,
     'pos_offset'    : (0, 0, 1.1),  # default pos_offset is (0, 0, 0)
...
FRAME_POST_PROCESSOR_CFG = {  # post process config
    ...
    'FPP_global_xlim' : (-1, 0.2),  # the x-direction limit for merged cloud points from all radars, set as [a, b), from global view
    'FPP_global_ylim' : (0, 3),
