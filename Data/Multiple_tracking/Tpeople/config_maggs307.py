...
FRAME_POST_PROCESSOR_CFG = {  # post process config
    ...
    'FPP_global_xlim' : (-2, 1.6),  # the x-direction limit for merged cloud points from all radars, set as [a, b), from global view
...
HUMAN_TRACKING_CFG = {  # tracking system config
    ...
    'TRK_obj_bin_number'              : 3,  # the maximum number of object which can be detected
...
HUMAN_OBJECT_CFG = {  # human object config for each object bin
    ...
    'inactive_timeout'          : 150,  # second, if timeout, object bin status goes inactive
    'obj_delete_timeout'        : 150,  # second, if timeout, delete this object bin
